...
def generate_report():
    ...
    members = [
        ...
        },
        {
            ...
            'nv3': 'Tối ưu hóa pipeline suy luận Transformer và đánh giá độ bền đối kháng Adversarial Robustness.',
            ...
            'w10': 'Tối ưu hóa suy luận & Độ bền:\n- Tối ưu hóa suy luận Transformer trên CPU.\n- Đánh giá độ bền đối kháng (Leetspeak, Base64).\n- Đạt độ trễ thấp trên CPU. Nộp R4.',
            'w11': 'Tích hợp Transformer Engine:\n- Viết wrapper suy luận DeBERTa-v3 cho API.\n- Tối ưu hóa pipeline batching & đa luồng CPU.\n- Đo đạc thông lượng xử lý RPS.',
            'w12': 'Chuẩn bị Hội Đồng 1:\n- Kiểm thử hiệu năng Transformer trên CPU.\n- Chuẩn bị slide thực nghiệm Chapter 4.\n- Tổng duyệt phần trình bày AI Model.',
            'w13': 'BÁO CÁO HỘI ĐỒNG 1 (MIDTERM):\n- Trình diễn trực tiếp mô hình DeBERTa-v3 Guardrail.\n- Chứng minh độ trễ thấp và FPR < 1.5%.\n- Bảo vệ thành công Prototype.',
        ...
        },
        {
            ...
            'w10': 'Tích hợp Guardrail Engine:\n- Kết nối mô hình phân loại vào FastAPI.\n- Thêm tính năng toggle chuyển đổi mô hình (TF-IDF / DeBERTa).\n- Tối ưu hóa xử lý lỗi HTTP 400/500.',
    ...
    tasks = [
        ...
        ('T20', 'Tuần 9 - 10 (02/11 - 15/11)', 'Fine-tuning DeBERTa-v3, Đánh giá Adversarial Robustness & Nộp Report No.4', 'Chưa bắt đầu', 'Việt & Đức', 'Report No.4 & models/', '15/11/2026'),
