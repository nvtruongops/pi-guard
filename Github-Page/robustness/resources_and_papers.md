...
> **Căn cứ đề tài**: Mục 3.2 trong Bản đăng ký đề tài chính thức **`CAPSTONE PROJECT REGISTER.md`**:
...
| **"Jailbroken: How Does LLM Safety Training Fail?"**<br>*Wei et al.* [[5]](#ref5) | *NeurIPS 2023* | Lý giải 2 nguyên nhân cốt lõi khiến căn chỉnh an toàn thất bại: Xung đột mục tiêu (Competing Objectives) và Lệch phân phối token. | [arXiv:2307.02483](https://arxiv.org/abs/2307.02483) |
...
| **"Bypassing LLM Guardrails: An Empirical Analysis of Evasion Attacks"**<br>*Hackett et al.* [[8]](#ref8) | *ACL 2025 Workshop LLMSEC* | Đánh giá thực nghiệm 12 kỹ thuật chèn ký tự (Emoji Smuggling 100% bypass Meta Prompt Guard) và 8 thuật toán AML Evasion; bảo chứng cho Heuristic Scrubber Tầng 0. | [ACL Anthology](https://aclanthology.org/2025.llmsec-1.9/) |
...
Dự án PI-Guard đã tích hợp sẵn các module kiểm thử và xử lý nhiễu đối kháng trong thư mục **`src/preprocessing/`**:

### A. Bộ Sinh Nhiễu Đối Kháng Tự Động: **`src/preprocessing/obfuscation.py`**
...
### B. Bộ Tiền Xử Lý Khử Nhiễu: **`src/preprocessing/cleaner.py`**
...
<a id="ref8"></a>**[8]** W. Hackett, L. Birch, S. Trawicki, N. Suri, and P. Garraghan, "Bypassing LLM Guardrails: An Empirical Analysis of Evasion Attacks against Prompt Injection and Jailbreak Detection Systems," in *Proceedings of The First Workshop on LLM Security (LLMSEC 2025) at ACL 2025*, 2025, pp. 101–114. Link: [https://aclanthology.org/2025.llmsec-1.9/](https://aclanthology.org/2025.llmsec-1.9/).