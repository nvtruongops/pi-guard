...
| <a id="ref11"></a>**11** | **`Shen_2024_Do_Anything_Now_Jailbreak_Prompts_In_The_Wild.pdf`**                           | [Shen et al. (2024)](https://arxiv.org/abs/2308.03825)                                 | _ACM CCS 2024_                  | • **`scripts/download_dataset.py`**<br>• **`Final-Report/PI-GUARD-Present-109.pptx`**<br>• **`notebooks/data/manifests/attack_taxonomy.json`**                                                                                                                                                                                                                                               | Dữ liệu Jailbreak thực tế (15,140 prompts công bố, gồm 1,405 jailbreak prompts thực tế), taxonomy DAN & Roleplay                                                                                |
