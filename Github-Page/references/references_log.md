...
5. **`Comprehensive Study of Jailbreak Attack vs. Defense`** (**`Phuong_2024_ACL_Comprehensive_Study_Jailbreak_Attack_Defense.pdf`**):
...
6. **`Exploring Vulnerabilities and Protections in LLMs Survey`** (**`Phuong_2024_Exploring_Vulnerabilities_Protections_LLMs_Survey.pdf`**):
...
7. **`Jailbreak Attacks and Defenses Against LLMs Survey`** (**`Phuong_2024_Survey_Jailbreak_Attacks_Defenses_LLMs.pdf`**):
