...
Tầng Tiền xử lý được hiện thực hóa trong **`src/preprocessing/cleaner.py`** và đảm nhiệm 3 nhiệm vụ khử nhiễu cốt lõi:
...
Để mô hình DeBERTa-v3 không bị suy giảm hiệu năng khi gặp các biến thể cú pháp mới trong thực tế, quy trình huấn luyện của PI-Guard áp dụng bộ tạo nhiễu **`ObfuscationGenerator`** lấy cảm hứng từ EasyJailbreak [[6]](#ref6):
