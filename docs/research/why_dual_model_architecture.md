...
| :--- | :---: | :---: | :--- | :---: |
| **1. Độ trễ suy luận P95 trên CPU** | **< 30 ms** (Zero GPU Production) | **~12.8 ms (ONNX INT8)**<br>*(~3.2 ms với TF-IDF)* | Đo đạc qua `LatencyProfiler` (**`src/evaluation/latency.py`**) trên CPU Intel Core i7 8 nhân. Nhanh hơn 40 lần so với Llama Guard. | ✅ **VƯỢT CHỈ TIÊU (XUẤT SẮC)** |
