...
> - **Fall 2026 Milestone Independence**: The **LỘ TRÌNH THỰC HIỆN & 4 CỘT MỐC CHÍNH (MILESTONE TIMELINE HỌC KỲ FALL 2026)** is defined specifically for the Fall 2026 semester schedule with Supervisor Trần Văn Ninh, and is **NOT** derived from the legacy timelines in `docs/fpt_capstone_guide/`.
...
- [`docs-portal-sync-and-deploy`](file:///d:/Work/Do-an/.agents/skills/docs-portal-sync-and-deploy/SKILL.md): Quy trình đồng bộ hóa tài liệu giữa repository và Cổng Tài Liệu Web UI (Github-Page & MkDocs Material), kiểm toán toàn vẹn neo/link và xuất bản tự động lên GitHub Pages.
