...
- ✅ [`src/app_demo_meeting5.py`](file:///d:/DoAn/pi-guard/workspaces/ducnq/src/app_demo_meeting5.py): **[MỚI - WEB DEMO DASHBOARD STREAMLIT]** Giao diện Web tương tác trực quan 3 Tab: Thử nghiệm Prompt 2 Tầng thời gian thực, Quét tài liệu 200k ký tự (PDF/Ebook), và Bảng đối soát số liệu A/B Testing bảo chứng học thuật trước Thầy Ninh & Hội đồng.
