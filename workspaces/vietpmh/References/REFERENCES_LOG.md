...
**Mục tiêu chính**: Nghiên cứu kiến trúc Transformer `microsoft/deberta-v3-base` (Disentangled Attention), đánh giá độ bền trước tấn công gián tiếp (BIPIA) và cơ chế Attention Shift (RAP-ID).  
