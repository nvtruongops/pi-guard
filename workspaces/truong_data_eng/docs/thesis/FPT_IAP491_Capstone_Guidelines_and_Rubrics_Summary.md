...
1. 🎯 **REVIEW 1** *(với GVHD)*: Xác định bài toán & Khảo sát nghiên cứu SOTA (**Chapter 1 & Chapter 2**).
2. 🎯 **REVIEW 2** *(với GVHD)*: Phương pháp luận, Dữ liệu Group-Aware Split & Baseline ML (**Chapter 3**).
3. 🏛️ **BÁO CÁO HỘI ĐỒNG 1** *(Hội đồng Giữa kỳ)*: Kết quả thực nghiệm Transformer DeBERTa-v3, ONNX INT8 & Prototype FastAPI/Streamlit (**Chapter 4**).
4. 🎓 **BÁO CÁO HỘI ĐỒNG FINAL** *(Hội đồng Tốt nghiệp)*: Toàn văn Luận văn 6 Chương hoàn chỉnh, Quét Turnitin (< 20%) & Bảo vệ Tốt nghiệp chính thức (**Chapters 1 – 6**).
...
Tuần 7 ────► [ CỘT MỐC 2: REVIEW 2 (GVHD) ] ──────────► Report No.3 (Methodology & Baseline ML)
Tuần 11-12─► [ CỘT MỐC 3: BÁO CÁO HỘI ĐỒNG 1 ] ──────► Report No.4 (Experimental, INT8 & Prototype)
