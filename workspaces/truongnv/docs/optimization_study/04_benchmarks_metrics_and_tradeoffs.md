...
```
┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│                   BẢNG ĐỐI SOÁNH ĐỊNH LƯỢNG GIỮA PI-GUARD VÀ CÁC GIẢI PHÁP GUARDRAIL QUỐC TẾ                    │
├────────────────────────┬───────────────────┬─────────────────────┬───────────────────┬───────────────────────────┤
│ Tiêu Chí Đánh Giá      │ Regex / Blacklist │ Llama Guard 3 8B    │ ProtectAI DeBERTa │ PI-GUARD (Đồ án Đề xuất)  │
│                        │                   │ (Meta AI 2023)      │ Baseline (Open)   │ (Two-Tier + ONNX INT8)    │
├────────────────────────┼───────────────────┼─────────────────────┼───────────────────┼───────────────────────────┤
...
│ False Positive (FPR)   │ > 18.0%           │ ~2.1%               │ ~1.8%             │ < 1.1% (Rất an toàn)      │
│ Kháng Leetspeak        │ ❌ Thất bại (<15%) │ ⚠️ Kém (~52%)       │ ⚠️ Kém (~61%)     │ ✅ Bền vững (>96% F1)     │
│ Kháng Base64/Cipher    │ ❌ Thất bại (0%)  │ ❌ Bị lừa (~12%)    │ ❌ Thất bại (<8%) │ ✅ Tự giải mã (>98% F1)   │
...
## ⚖️ III. BA TAM GIÁC ĐÁNH ĐỔI TRỌNG YẾU (CORE SYSTEM TRADE-OFFS)
