...
| **3** | **Ignore This Title**<br>*(Perez & Ribeiro, 2022)* | **NeurIPS 2022** | [`Perez_2022_Ignore_This_Title_Hack_This_Paper_Prompt_Injection.pdf`](file:///d:/Work/Do-an/References/Perez_2022_Ignore_This_Title_Hack_This_Paper_Prompt_Injection.pdf) | Bài báo đầu tiên định nghĩa chính thức bài toán Prompt Injection, Goal Hijacking và System Prompt Leaking. |
