...
> 📓 **Interactive Replication Notebook (PI-Guard Capstone Project)**:  
> Check out [`PIGuard_ACL2025_Replication_and_Paper_Comparison.ipynb`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGuard_ACL2025/PIGuard_ACL2025_Replication_and_Paper_Comparison.ipynb) for an end-to-end interactive evaluation notebook that reproduces all benchmarks (NotInject, WildGuard, BIPIA, Valid), cross-references empirical results against official ACL 2025 paper metrics (Table 1 & Table 7), generates publication figures, and persists structured results.
