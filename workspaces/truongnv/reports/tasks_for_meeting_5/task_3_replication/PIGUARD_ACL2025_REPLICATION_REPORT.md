...
**Người thực hiện**: Nguyễn Văn Trường (Leader — MSSV: `SE182034`) | **Workspace**: `workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/`  
...
**Tệp dữ liệu kết quả đo đạc JSON**: [`PIGUARD_REPLICATION_BENCHMARK_RESULTS.json`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGUARD_REPLICATION_BENCHMARK_RESULTS.json)  
**Notebook kiểm định đồng bộ 11 Phân Hệ**: [`PIGuard_ACL2025/PIGuard_ACL2025_Replication_and_Paper_Comparison.ipynb`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGuard_ACL2025/PIGuard_ACL2025_Replication_and_Paper_Comparison.ipynb)  
...
- **Mã nhận diện học thuật**: arXiv:2410.22770 [cs.CR] | Bản lưu trữ cục bộ: [`papers/PIGuard_ACL2025_arXiv2410.22770.pdf`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/papers/PIGuard_ACL2025_arXiv2410.22770.pdf)
...
2. **Đo đạc điểm nghẽn thực tế**: Khảo sát hiệu năng và độ trễ thực tế trên CPU nhằm cung cấp cơ sở bảo chứng cho **Cải tiến 3 (Two-Tier Routing)** và **Cải tiến 4 (ONNX INT8 Quantization)** trong Task 4.
...
- **Môi trường thực thi**: Python 3.10.11 đặt trong môi trường ảo độc lập [`PIGuard_ACL2025/.venv`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGuard_ACL2025/.venv/).
...
- **Mã nguồn thực thi tái lập**: Script tự động hóa chuẩn [`PIGuard_ACL2025/eval_replication.py`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGuard_ACL2025/eval_replication.py) và Notebook kiểm định [`PIGuard_ACL2025/PIGuard_ACL2025_Replication_and_Paper_Comparison.ipynb`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGuard_ACL2025/PIGuard_ACL2025_Replication_and_Paper_Comparison.ipynb).

---

## PHÂN HỆ 3: KHÁM PHÁ TÀI NGUYÊN DỮ LIỆU (DATASET DISCOVERY)

Toàn bộ dữ liệu kiểm định được nạp nguyên bản từ thư mục [`PIGuard_ACL2025/datasets/`](file:///d:/Work/Do-an/workspaces/truongnv/reports/tasks_for_meeting_5/task_3_replication/PIGuard_ACL2025/datasets/), tổng cộng **1.579 mẫu**:
...
> 🔍 **Ý nghĩa kiến trúc cho đồ án**: Trong ứng dụng phòng hộ trực tuyến độ trễ thấp (Low-Latency Online Guardrail), độ trễ $1.37\text{s}$ trên CPU là điểm nghẽn lớn. Đây là căn cứ khoa học trực tiếp để đề tài PI-Guard phát triển giải pháp **Lượng hóa Dynamic INT8 trên ONNX Runtime (Cải tiến 4)** nhằm đưa độ trễ về $\text{P95} < 30\text{ms}$.
