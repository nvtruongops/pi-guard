...
1. **Biên dịch Luận văn**:
   ...
   ```
   Lệnh này sẽ tự động gộp các chương từ `chapters/`, chèn trang bìa chuẩn FPT University, chèn danh mục tài liệu tham khảo từ `reports/References/REFERENCES_LOG.md` và xuất ra `FINAL_THESIS.md`.
...
2. **Đồng bộ lên Cổng Web GitHub Pages**:
   ...
   ```
   Script sẽ tự động đọc từ `reports/thesis/`, chuẩn hóa liên kết và sao chép sang `docs/thesis/` để hiển thị trên cổng web GitHub Pages (MkDocs Material).
