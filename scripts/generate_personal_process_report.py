...
def create_personal_process_report():
    ...
    ws1["A2"] = "Khóa luận Tốt nghiệp: PI-Guard | Ngành An toàn Thông tin (IA) — Đại học FPT"
    ...
    milestones_data = [
        ("CỘT MỐC 1: REVIEW 1 (GVHD)", "Tuần 1 - 4 (23/08 - 19/09)", "Chủ trì Chapter 1, Chapter 2, Threat Model & Dàn ý Slide", "chapters/01 & 02, Hồ sơ Review 1", "35% Quá trình", "Đang thực hiện", "Hoàn thành biên bản họp 1, đang hoàn thiện 2 chương"),
        ("CỘT MỐC 2: REVIEW 2 (GVHD)", "Tuần 5 - 7 (20/09 - 10/10)", "Cào 5 datasets HF, code Group-Aware Split, hỗ trợ Baseline", "data/splits/ & src/datasets/splitter.py", "25% Quá trình", "Chưa bắt đầu", "Chuẩn bị dataset cho mô hình TF-IDF"),
        ("CỘT MỐC 3: HỘI ĐỒNG 1 (MIDTERM)", "Tuần 8 - 12 (11/10 - 14/11)", "Kiểm định rò rỉ dữ liệu, test tích hợp API Middleware & Demo", "Prototype hoàn chỉnh & Chapter 4", "Báo cáo Hội đồng", "Chưa bắt đầu", "Bảo vệ Demo trước Hội đồng giữa kỳ"),
        ("CỘT MỐC 4: HỘI ĐỒNG FINAL", "Tuần 13 - 15 (15/11 - 05/12)", "Tổng hợp toàn văn 6 chương FINAL_THESIS & Slide bảo vệ", "FINAL_THESIS.md & Slide Final", "Bảo Vệ Tốt Nghiệp", "Chưa bắt đầu", "Bảo vệ chính thức trước Hội đồng Chấm thi")
    ]
    ...
    personal_tasks = [
        ("T01-NVT", "Tuần 1 (23/08 - 29/08)", "Họp khởi động với GVHD, thống nhất mục tiêu đề tài PI-Guard", "Hoàn thành", "Meeting 1_29_08_26.md", "29/08/2026", "Đã chốt mục tiêu và phạm vi với Thầy"),
        ("T02-NVT", "Tuần 1 (23/08 - 29/08)", "Khảo sát và thu thập 17 bài báo IEEE/ACM >= 2022 về LLM Security", "Hoàn thành", "References/REFERENCES_LOG.md", "30/08/2026", "Đã lập ma trận liên kết 17 papers"),
        ("T03-NVT", "Tuần 2 (30/08 - 05/09)", "Soạn thảo Chapter 1: Background, Problem Statement (Von Neumann NLP)", "Đang thực hiện", "workspaces/truong_data_eng/docs/chapters/01", "31/08/2026", "Đang hoàn thiện phần bối cảnh"),
        ("T04-NVT", "Tuần 2 (30/08 - 05/09)", "Phân loại mối đe dọa (Threat Taxonomy: Direct/Indirect vs Jailbreak)", "Đang thực hiện", "workspaces/truong_data_eng/docs/thesis/", "01/09/2026", "Đã ánh xạ theo OWASP LLM01:2025"),
        ("T05-NVT", "Tuần 2 (30/08 - 05/09)", "Soạn thảo Chapter 2: Literature Review, SOTA Matrix & Research Gaps", "Đang thực hiện", "workspaces/truong_data_eng/docs/chapters/02", "03/09/2026", "Đã phân tích SOTA ProtectAI, NeMo"),
        ("T06-NVT", "Tuần 2 (30/08 - 05/09)", "Biên soạn Hồ sơ Kỹ thuật Review 1 & Dàn ý Slide 9 trang thuyết trình", "Đang thực hiện", "workspaces/truong_data_eng/docs/thesis/", "04/09/2026", "Chuẩn bị kịch bản thuyết trình 15 phút"),
        ("T07-NVT", "Tuần 2 (30/08 - 05/09)", "Điều phối họp nhóm cuối tuần, tổng kết và đồng bộ bản chính thức Review 1", "Chưa bắt đầu", "PI_GUARD_PROCESS_REPORT.xlsx", "06/09/2026", "Họp cả 4 thành viên thống nhất"),
        ("T08-NVT", "Tuần 3 - 4 (06/09 - 19/09)", "Chủ trì phần thuyết trình và BẢO VỆ REVIEW 1 TRƯỚC GVHD", "Chưa bắt đầu", "Biên bản nghiệm thu Review 1", "19/09/2026", "Bảo vệ thành công Chapter 1 & 2"),
        ("T09-NVT", "Tuần 5 - 6 (20/09 - 03/10)", "Tải 5 bộ dataset từ Hugging Face & viết thuật toán Group-Aware Split", "Chưa bắt đầu", "src/datasets/splitter.py", "03/10/2026", "Đảm bảo Jaccard similarity < 0.15"),
        ("T10-NVT", "Tuần 5 - 6 (20/09 - 03/10)", "Đánh giá phân phối nhãn, kiểm tra độ rò rỉ dữ liệu giữa Train/Val/Test", "Chưa bắt đầu", "notebooks/01_dataset_analysis", "03/10/2026", "Tránh rò rỉ mẫu tương tự"),
        ("T11-NVT", "Tuần 7 (04/10 - 10/10)", "Hoàn thiện Chapter 3 (Methodology) & BẢO VỆ REVIEW 2 TRƯỚC GVHD", "Chưa bắt đầu", "Report No.3 & datasets", "10/10/2026", "Nghiệm thu phương pháp luận và dữ liệu"),
        ("T12-NVT", "Tuần 8 - 9 (11/10 - 24/10)", "Hỗ trợ thử nghiệm nén Transformer INT8 & kiểm toán độ bền Robustness", "Chưa bắt đầu", "models/onnx/ & Chapter 4", "24/10/2026", "Đo lường độ trễ trên CPU"),
        ("T13-NVT", "Tuần 10 - 12 (25/10 - 14/11)", "Điều phối kiểm thử tích hợp FastAPI Middleware & BẢO VỆ HỘI ĐỒNG 1", "Chưa bắt đầu", "Hệ thống Prototype Demo", "14/11/2026", "Bảo vệ Demo trước Hội đồng giữa kỳ"),
        ("T14-NVT", "Tuần 13 - 14 (15/11 - 28/11)", "Biên dịch toàn văn Master Thesis 6 chương qua script và quét Turnitin", "Chưa bắt đầu", "docs/thesis/FINAL_THESIS.md", "28/11/2026", "Đảm bảo độ trùng lặp Turnitin < 20%"),
        ("T15-NVT", "Tuần 15 (29/11 - 05/12)", "Chủ trì BẢO VỆ TỐT NGHIỆP CHÍNH THỨC TRƯỚC HỘI ĐỒNG FPT", "Chưa bắt đầu", "Slide Bảo vệ & Đồ án hoàn chỉnh", "05/12/2026", "Tốt nghiệp đạt điểm xuất sắc")
    ]
    ...
    wb.save(output_path)
    print(f"Personal Process Report (Tieng Viet co dau chuan) saved to: {output_path}")
