...
def preprocess_and_split(
    input_path: str = "Final-Report/notebooks/data/raw/combined_raw.csv" if os.path.exists("Final-Report/notebooks/data/raw") else ("notebooks/data/raw/combined_raw.csv" if os.path.exists("notebooks/data/raw") else "data/raw/combined_raw.csv"),
    ...
    config_path: str = "Final-Report/notebooks/configs/data.yaml" if os.path.exists("Final-Report/notebooks/configs/data.yaml") else ("notebooks/configs/data.yaml" if os.path.exists("notebooks/configs/data.yaml") else "configs/data.yaml")
):
    if not os.path.exists(input_path):
        for c in [os.path.join("Final-Report/notebooks", input_path), os.path.join("notebooks", input_path)]:
            if os.path.exists(c):
                input_path = c
                break
